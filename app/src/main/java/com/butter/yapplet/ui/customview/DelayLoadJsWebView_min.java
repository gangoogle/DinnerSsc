...
public class DelayLoadJsWebView_min extends WebView {
...
//    };
    ...
    public DelayLoadJsWebView_min(Context context) {
        super(context);
        mContext = context;
        initSetting();
    }
    ...
    public DelayLoadJsWebView_min(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        initSetting();
    }

    public DelayLoadJsWebView_min(Context context, AttributeSet attrs, int defStyleAttr) {
