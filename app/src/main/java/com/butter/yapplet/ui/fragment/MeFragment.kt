...
import com.butter.yapplet.model.event.FinishEvent
import com.butter.yapplet.ui.activity.CollectionActivity
import com.butter.yapplet.ui.activity.FeedBackActivity
import com.butter.yapplet.ui.activity.LoginActivityFix
...
class MeFragment : BaseFragment() {
    ...
    override fun initViewData() {
        ...
        mView?.tv_un_register?.setOnClickListener {
            ...
            context.startActivity(Intent(context, LoginActivityFix::class.java))
