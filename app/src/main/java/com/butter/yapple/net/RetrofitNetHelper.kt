...
import com.butter.yapple.net.HttpLoggingInterceptor as MyInterceptor
...
import com.butter.yapple.net.BasicParamsInterceptor
import com.butter.yapple.net.UrlInterceptor
...
class RetrofitNetHelper private constructor(val context: Context) {
    ...
    //默认url
    val baseUrl = Constant.SERVER_URL
    //缓存
